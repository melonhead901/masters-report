...
The primary research question Celeriac answers is what kinds of contracts can be inferred from programs. Important related research questions are, which of these inferred contracts do developers choose to include in their subject. 
\section{Conclusion}
